                ...
                return (
                    <div key={key} className='bg-white border border-[#EEEDED] gap-[14px] rounded-[14px] p-[20px] flex flex-col min-h-[155px]'>
                        <div className='flex w-full gap-5 items-center'>
                            ...
                            <p className='leading-[130%] tracking-[0%] text-black text-[14px] flex-1'>{data.textOne} <br /> {data.textTwo}</p>
                        </div>

                        <h4 className='w-full text-black h-[30px] text-[20px] leading-[100%] tracking-[0%] break-words'>{data.data}</h4>
                        <h4 className='w-full h-[15px] text-[10px] leading-[100%] tracking-[0%] text-[#838383]'>{data.number} {data.text}</h4>
                    </div>
                )
            })}
