...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center rounded-[20px] w-full bg-white py-[10px] lg:px-[30px] px-[10px]'>
      ...
      <div className='flex justify-between w-20 lg:w-[132px] h-6 gap-[30px]'>
        <Search className='cursor-pointer hover:text-orange-400 transition-colors duration-200 h-6 w-5' />
        <Notification className='cursor-pointer hover:text-orange-400 transition-colors duration-200 h-6 w-5' />
        <Setting className='hide cursor-pointer hover:text-orange-400 transition-colors duration-200 h-6 w-5' />
        <Menu onClick={menuToggle} className='hidden show cursor-pointer hover:text-orange-400 transition-colors duration-200 h-6 w-5' />
